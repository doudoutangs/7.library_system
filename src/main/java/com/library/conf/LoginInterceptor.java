...
public class LoginInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (users == null) {
            ...
            if (requestType != null && requestType.equals("XMLHttpRequest")) {
                ...
                response.sendRedirect("/toHomeView");
            }
            return false;
        } else {
    ...
    private boolean doLoginInterceptor(String path, String basePath) {
        ...
        notLoginPaths.add("/");
        notLoginPaths.add("/bs/book");
        notLoginPaths.add("/sys/login/register");

        notLoginPaths.add("/toError");

        notLoginPaths.add("/toHomeView");
        notLoginPaths.add("/toRegisterView");
        notLoginPaths.add("/toLoginView");
