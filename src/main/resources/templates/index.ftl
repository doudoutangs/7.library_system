        ...
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <cite>${user.realName?if_exists}</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a lay-href="/sys/user/info">基本资料</a></dd>
                        <dd><a lay-href="/modifyPassword">修改密码</a></dd>
                        <hr>
...
<script>
    layui.config({
        ...
        var $ = layui.$,admin = layui.admin,router = layui.router(),search = router.search;
            ...
            admin.req({
                ...
                dataType: "json",
                    ...
                    for (var i=0;i<data.length;i++){
                        var menu=data[i];
                        var clas=(i==0)?'class="layui-nav-item layui-nav-itemed"':'class="layui-nav-item"';
                        var li='<li  '+clas+'>';
                        ...
                        var a_tag='<a href="javascript:;" '+op+' lay-tips="'+menu.menuName+'" lay-direction="2"> ' +
                        ...
                        if(menu.children && cList.length>0){
                            for (var j=0;j<cList.length;j++){
                                var inclass=(i==0&&j==0)?'class="layui-this"':"";
                                var c=cList[j];
                                var cUrl=c.url?c.url:'#';
                                var dd='<dd '+inclass+'>' +
                                        '<a lay-href="'+c.url+'">'+c.menuName+'</a>' +
                                        '</dd>';
                                dl+=dd;
                            }
                        }
                    ...
                    $('#LAY-system-side-menu').html(htmlTree);
