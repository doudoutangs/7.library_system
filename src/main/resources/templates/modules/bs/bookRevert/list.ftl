                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">借书人电话：</label>
                            <div class="layui-input-inline">
                                <input type="text" name="phone" placeholder="借书人电话" autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <script type="text/html" id="toolbar-operation-btn">
                        <@shiro.hasPermission name="bs:bookRevert:revert">
                            <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="revert"><i
                                        class="layui-icon layui-icon-heart-fill"></i>还书</a>
                        </@shiro.hasPermission>
                        <@shiro.hasPermission name="bs:bookRevert:delayRevert">
                            <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="delayRevert"><i
                                        class="layui-icon layui-icon-heart-fill"></i>还书延期</a>
                        </@shiro.hasPermission>
                        <@shiro.hasPermission name="bs:bookRevert:loss">
                            <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="loss"><i
                                        class="layui-icon layui-icon-heart-fill"></i>定损</a>
                        </@shiro.hasPermission>
                    </script>
...
<script>
    layui.config({
        ...
        bookRevertList: 'bs/bookRevertList',
    }).use(['index', 'bs/bookRevertList', 'table'], function () {
