            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <script type="text/html" id="toolbar-operation-btn">
                        ...
                        <@shiro.hasPermission name="bs:book:batchDel">
                            <button class="layui-btn-danger layuiadmin-btn-list layui-btn-primary layui-btn-sm layui-icon layui-icon-delete"
                                    lay-event="batchdel">批量删除
                            </button>
                        </@shiro.hasPermission>
                        <@shiro.hasPermission name="bs:bookOperate:batchAdd">
                            <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="lend"><i
                                        class="layui-icon layui-icon-heart"></i>借书</a>
                        </@shiro.hasPermission>
<#--                        <@shiro.hasPermission name="bs:bookOperate:batchAdd">-->
...
<#--                        </@shiro.hasPermission>-->
                    ...
                    <script type="text/html" id="table-content-list">
                        ...
                        <@shiro.hasPermission name="bs:book:edit">
                            <a class="layui-btn layui-btn layui-btn-xs" lay-event="edit">
                                <i class="layui-icon layui-icon-edit"></i>编辑
                            </a>
                        </@shiro.hasPermission>
                        <@shiro.hasPermission name="bs:book:delete">
...
<script>
    layui.config({
        ...
        bookList: 'bs/bookList',
    }).use(['index', 'bs/bookList', 'table'], function () {
