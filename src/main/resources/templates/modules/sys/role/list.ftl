                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width:250px">
                                <input type="text" name="keyword" placeholder="角色名称模糊搜索" autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <script type="text/html" id="toolbar-operation-btn">
                        <@shiro.hasPermission name="sys:role:add">
                            <button class="layui-btn layuiadmin-btn-list layui-btn-sm layui-icon layui-icon-add-1"
                                    data-type="add" lay-event="add"> 添加
                            </button>
                        </@shiro.hasPermission>
                        <@shiro.hasPermission name="sys:role:auth">
                            <button class="layui-btn layui-btn-primary layui-btn-sm layui-icon layui-icon-spread-left"
                                    lay-event="auth"> 权限设置
                            </button>
                        </@shiro.hasPermission>
                    </script>
                    ...
                    <script type="text/html" id="table-content-list">
                        <@shiro.hasPermission name="sys:role:userlist">
                            <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="manage"><i
                                        class="layui-icon layui-icon-username"></i>用户列表</a>
                        </@shiro.hasPermission>
...
<script>
    ...
    }).use(['index', 'sys/roleList', 'table'], function () {
