                    ...
                    <form class="layui-form" lay-filter="depart-edit-form" id="depart-edit-form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" lay-filter="tree" id="tree" name="parentTree" placeholder="请输入标题"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="number" name="sort" required lay-verify="required" placeholder="请输入排序值"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-row layui-col-space10 layui-form-item">
                            <div class="layui-col-lg6">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="leader" lay-verify="required" placeholder="请输入负责人名字"
                                           autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-col-lg6">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="phone" placeholder="请输入负责人联系电话" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="email" lay-verify="email" placeholder="请输入负责人邮箱"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                ...
                                <button type="button" lay-reset lay-filter="dept-from-reset" id="dept-from-reset"
                                        class="layui-btn layui-btn-normal">置为新增模式
                                </button>
                                <button class="layui-btn" lay-submit lay-filter="dept-form-delete"
                                        id="dept-from-delete">删除
                                </button>
                            </div>
                        </div>
                    </form>
...
<script>
    layui.config({
        ...
        $("#dept-from-delete").on("click", function () {
            var id = $("#id").val();
