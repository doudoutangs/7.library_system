        ...
        <div class="layui-col-md10">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width:290px">
                                <input type="text" name="keyword" placeholder="可根据用户名/真实姓名/邮箱/手机号查询" autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
            ...
            <div class="layui-card">
                <div class="layui-card-header">
                    <span class="layui-dept-define layui-bg-red" style="font-size:15px;font-weight:bold">部门</span>&nbsp;下的用户列表
                </div>
                <div class="layui-card-body">
...
<script>
    ...
    }).use(['index', 'sys/userList', 'table', 'treeSelect'], function () {
