;layui.define(["table", "treeTable", "form"], function (t) {
    ...
    var instb=treetable.render({
        ...
        cols: [[{type: "checkbox", fixed: "left"},
            ...
            {field: "menuName",title: "名称",minWidth: 150},
            {field: "url", title: "请求路径",minWidth: 150},
            {field:"menuType",title:"类型",minWidth:50,templet:"#table-menuType-btn"},
            {field:"permission",title:"权限编码",minWidth: 150},
