;layui.define(["table", "form"], function (t) {
    ...
    table.render({
        ...
        cols: [[
            ...
            {field: "releaseDate", title: "发布日期", width: 120},
    ...
    table.on("tool(LAY-app-content-list)", function (t) {
        ...
        switch (t.event) {
            case 'del':
                layer.confirm("确定删除该公告？", function (cf) {
                    admin.req({
                        type: "DELETE",
                        cache: false,
                        url: "/bs/notice/delete/" + e.id,
                        done: function (res) {
                            layer.msg('删除成功！', {
                                time: 1000 //20s后自动关闭
                            });
